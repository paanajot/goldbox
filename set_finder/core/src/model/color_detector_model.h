 ...
 * Source code for file 'color_detector_model.tflite', last modified 1704280911.
 * Do not modify this file.
 */
#ifndef COLOR_DETECTOR_MODEL_H
#define COLOR_DETECTOR_MODEL_H
...
namespace bin2cpp
{
  ...
  const ColorModel & getColorModelFile();
}; //bin2cpp

#endif //COLOR_DETECTOR_MODEL_H

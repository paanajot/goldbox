 ...
 * Source code for file 'fdeep_color_detector.json', last modified 1675356956.
 * Do not modify this file.
 */
#ifndef FDEEP_COLOR_DETECTOR_H
#define FDEEP_COLOR_DETECTOR_H
